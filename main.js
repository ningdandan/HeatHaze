...
var halo = new Image();
var erwin_shadow = new Image();
var erwin = new Image();
var fire_bottom = new Image();
var horse_shadow = new Image();
var horse = new Image();
var levi_shadow = new Image();
var levi = new Image();
var sword = new Image();
var mask = new Image();
var fire_top_1 = new Image();
var fire_top_2 = new Image();
var fire_top_3 = new Image();
var fire_spark_1 = new Image();
var fire_spark_2 = new Image();
var fire_spark_3 = new Image();
...
var layer_list = [
	{
		'image': background,
		'src': './image/compressed/background-min.png',
		'z_index': -1,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': radiant,
		'src': './image/compressed/radiant-min.png',
		'z_index':-1,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': halo,
		'src': './image/compressed/halo-min.png',
		'z_index': -3,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': levi_shadow,
		'src': './image/compressed/levi_shadow-min.png',
		'z_index': 0,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 0.5
	...
	{
		'image': horse_shadow,
		'src': './image/compressed/horse_shadow-min.png',
		'z_index': 0,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 0.5
	...
	{
		'image': fire_spark_3,
		'src': './image/compressed/fire_spark_3_1-min.png',
		'z_index': 25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
...
function getOffset(layer) {
	...
	// 	console.log('waifu')
	// 	offset.y+=1
	// 	// motion_offset_y += levi_transform;
	// 	// touch_offset_y += levi_transform;
	// }
